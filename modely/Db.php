...
class Db
    {
        ...
        */
        ...
        public static function pripoj($host, $uzivatel, $heslo, $databaze) : void
            {
         ...
         */
        public static function dotazJeden($dotaz, $parametry = []) : array|bool
            {
         ...
         */
        public static function dotazVsechny($dotaz, $parametry = []) : array|bool
            {
                $navrat = self::$spojeni->prepare($dotaz);
                $navrat->execute($parametry);
         ...
         */
        public static function dotazSamotny($dotaz, $parametry = []) :string|null
            {
         ...
         */
        public static function dotaz($dotaz, $parametry = [])  : int
            {
                $navrat = self::$spojeni->prepare($dotaz);
                $navrat->execute($parametry);
         ...
         */    
        public static function vloz($tabulka, $parametry = []) : bool
            {    
         ...
         * @return bool TRUE v případě úspěšného provedení dotazu
         */    
        public static function zmen($tabulka, $hodnoty = [], $podminka, $parametry = []) : bool
            {
